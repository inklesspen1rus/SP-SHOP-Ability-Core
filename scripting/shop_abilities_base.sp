...
public void OnPluginStart()
{
	...
	offs_Alpha		= FindSendPropInfo("CBasePlayer", "m_clrRender") + 3;
...
{
	if(IsFakeClient(client))	SetEntityGravity(client, 1.0 / (Abilities2_GetClientAttributeFloat(client, "gravity") + 1.0));
}
